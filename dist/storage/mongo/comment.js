...
exports.CommentStorage = void 0;
const Comment_1 = __importDefault(require("../../models/Comment"));
const logger_1 = require("../../config/logger");
const appError_1 = __importDefault(require("../../utils/appError"));
class CommentStorage {
    constructor() {
        this.scope = 'storage.comment';
    }
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Comment_1.default.find(Object.assign({}, query));
                return dbObj;
            }
            catch (error) {
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Comment_1.default.findOne(Object.assign({}, query));
                if (!dbObj) {
                    logger_1.logger.warn(`${this.scope}.get failed to findOne`);
                    throw new appError_1.default(404, 'comment_404');
                }
                return dbObj;
            }
            catch (error) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Comment_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Comment_1.default.findByIdAndUpdate(id, payload, {
                    new: true
                });
                if (!dbObj) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Comment_1.default.findByIdAndDelete(id);
                if (!dbObj) {
    ...
    deleteMany(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Comment_1.default.deleteMany({ post_id: id });
                if (!dbObj) {
                    logger_1.logger.warn(`${this.scope}.delete failed to findByIdAndDelete`);
                    throw new appError_1.default(404, 'comment_404');
                }
