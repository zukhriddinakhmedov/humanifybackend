...
exports.DeletedPostStorage = void 0;
const DeletedPost_1 = __importDefault(require("../../models/DeletedPost"));
const logger_1 = require("../../config/logger");
const appError_1 = __importDefault(require("../../utils/appError"));
class DeletedPostStorage {
    constructor() {
        this.scope = 'storage.deletedPost';
    }
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield DeletedPost_1.default.find(Object.assign({}, query));
                return dbObj;
            }
            catch (error) {
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield DeletedPost_1.default.findOne(Object.assign({}, query));
                if (!dbObj) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield DeletedPost_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield DeletedPost_1.default.findByIdAndDelete(id);
                if (!dbObj) {
...
exports.DeletedPostStorage = DeletedPostStorage;
