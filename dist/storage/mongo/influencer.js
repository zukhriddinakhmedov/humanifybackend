...
exports.InfluencerStorage = void 0;
const Influencer_1 = __importDefault(require("../../models/Influencer"));
const logger_1 = require("../../config/logger");
const appError_1 = __importDefault(require("../../utils/appError"));
class InfluencerStorage {
    constructor() {
        this.scope = 'storage.influencer';
    }
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Influencer_1.default.find(Object.assign({}, query), { password: false });
                return dbObj;
            }
            catch (error) {
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Influencer_1.default.findOne(Object.assign({}, query), { password: false });
                if (!dbObj) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Influencer_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Influencer_1.default.findByIdAndUpdate(id, payload, {
                    new: true
                });
                if (!dbObj) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Influencer_1.default.findByIdAndDelete(id);
                if (!dbObj) {
...
exports.InfluencerStorage = InfluencerStorage;
