...
exports.LikeStorage = void 0;
const Likes_1 = __importDefault(require("../../models/Likes"));
const logger_1 = require("../../config/logger");
const appError_1 = __importDefault(require("../../utils/appError"));
class LikeStorage {
    constructor() {
        this.scope = 'storage.like';
    }
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Likes_1.default.find(query);
                return dbObj;
            }
            catch (error) {
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Likes_1.default.findOne(query);
                if (!dbObj) {
                    logger_1.logger.warn(`${this.scope}.get failed to findOne`);
                    throw new appError_1.default(404, 'like_404');
                }
                return dbObj;
            }
            catch (error) {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Likes_1.default.create(payload);
                return dbObj;
            }
            catch (error) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let dbObj = yield Likes_1.default.findByIdAndDelete(id);
                if (!dbObj) {
...
exports.LikeStorage = LikeStorage;
